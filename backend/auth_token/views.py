...
class UserLogin(mixins.ListModelMixin,mixins.CreateModelMixin, generics.GenericAPIView):
...
class UserSignUp(mixins.ListModelMixin ,mixins.CreateModelMixin, generics.GenericAPIView):
